 ...
 */
public class SecondAuthorizationServerLiveTest {

    private static final String USERNAME = "john-tenant2@test.com";
    private static final String PASSWORD = "123";

    private static final String CLIENT_ID = "lssoClient";
    private static final String CLIENT_SECRET = "lssoSecret";

    private static final String AUTH_SERVER_BASE_URL = "http://localhost:8084/auth/realms/tenant2";
