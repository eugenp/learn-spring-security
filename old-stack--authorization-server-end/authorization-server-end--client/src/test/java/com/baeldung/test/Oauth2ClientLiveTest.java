...
public class Oauth2ClientLiveTest {
    ...
    final String authorizeUrl = "http://localhost:8083/um-webapp-auth-server/oauth/authorize?response_type=code&client_id=lssoClient&scope=read&redirect_uri=" + redirectUrl;
    final String tokenUrl = "http://localhost:8083/um-webapp-auth-server/oauth/token";
    final String resourceUrl = "http://localhost:8082/um-webapp-client/users";
    ...
    public void givenAuthorizationCodeGrant_whenLoginUsingOauth_thenSuccess() throws UnsupportedEncodingException {
        ...
        int stateStart = fullAuthorizeUrl.indexOf("state=") + 6;
