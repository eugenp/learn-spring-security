...
public class ResourceServerLiveTest {
    ...
    private static final String USERNAME_WITHOUT_EMAIL_FORMAT = "john_test_username";
    ...
    @Test
    public void givenUserHavingUsernameWithEmailFormat_whenGetProjectResource_thenSuccess() {
        String accessToken = obtainAccessToken("read", USERNAME, PASSWORD);
        System.out.println("ACCESS TOKEN: " + accessToken);
    ...
    @Test
    public void givenUserHavingUsernameWithoutEmailFormat_whenGetProjectResource_thenForbidden() {
        String accessToken = obtainAccessToken("read", USERNAME_WITHOUT_EMAIL_FORMAT, PASSWORD);
        System.out.println("ACCESS TOKEN: " + accessToken);
