...
-- test@email.com/pass - default admin
-- user@email.com/pass - default user
insert into user (id, email, password, enabled, created, secret) values (1, 'test@email.com', '$2a$04$kqRvgmJBlWZQQ2c9NT9IH.ZhxFY07Y2xE73vmLHxBq2hNTvGvUc5m', true,  NOW(), null);
...
insert into user (id, email, password, enabled, created, secret) values (2, 'user@email.com', '$2a$04$kqRvgmJBlWZQQ2c9NT9IH.ZhxFY07Y2xE73vmLHxBq2hNTvGvUc5m', true,  NOW(), null);
