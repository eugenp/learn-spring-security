...
public class TaskResourceServerIntegrationTest {
    ...
    private static final String TASK_SVC_ENDPOINT_URL = "/api/tasks";
    ...
    @Test
    public void notGivenJwt_whenGetTasksEndpoint_thenUnauthorized() throws Exception {
        this.mvc.perform(get(TASK_SVC_ENDPOINT_URL + "?projectId=1"))
